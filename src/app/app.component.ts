...
export class AppComponent implements OnInit {
  ...
  dropDown() {
    if (this.pager.totalPages <= 6) {
      console.log("less than 6 pages");
    } else if (this.pager.totalPages > 6) {
      console.log("greater than 6 pages");
      for (var i = 7; i < this.pager.pages.length; i++){
        this.setDropdown.push(i);
      }
      console.log("dropdown", this.setDropdown);
  }
}
  ...
  ngOnInit() {
    this.allItems = JSON.parse(this.dummyData);
    console.log('dummydata', this.allItems);
